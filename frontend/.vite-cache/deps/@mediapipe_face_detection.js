...
var require_face_detection = __commonJS({
  "node_modules/@mediapipe/face_detection/face_detection.js"(exports) {
    (function() {
      ...
      ;
      var U = "function" === typeof Symbol && "symbol" === typeof /* @__PURE__ */ Symbol() ? /* @__PURE__ */ Symbol(void 0) : void 0;
      function Ya(a, b) {
      ...
      var Y = Wb(function(a, b, c) {
        ...
        b = V(b, c);
        if (null != b && null != b) if (S(a.g, 8 * c), a = a.g, c = b, 0 <= c) S(a, c);
        else {
        ...
        a = a.h;
        var g;
        if (ya) (g = xa) || (g = xa = new TextDecoder("utf-8", { fatal: true })), g = g.decode(a.subarray(e, e + d));
        else {
          d = e + d;
      ...
      function Hc(a) {
        ...
        return J(function(p) {
          switch (p.g) {
            ...
            case 2:
              c = p.h;
              if ("object" === typeof window) return Dc("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), Dc("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), f = b.filter(function(n) {
      ...
      x.setOptions = function(a, b) {
        ...
        if (b = b || this.g.options) {
          for (var d = [], e = [], g = {}, f = C(Object.keys(a)), h = f.next(); !h.done; g = { R: g.R, S: g.S }, h = f.next()) {
            var k = h.value;
            k in this.j && this.j[k] === a[k] || (this.j[k] = a[k], h = b[k], void 0 !== h && (h.onChange && (g.R = h.onChange, g.S = a[k], d.push(/* @__PURE__ */ (function(l) {
              return function() {
                var m;
                return J(function(q) {
          ...
          if (0 !== d.length || 0 !== e.length) this.s = true, this.B = (void 0 === this.B ? [] : this.B).concat(e), this.A = (void 0 === this.A ? [] : this.A).concat(d);
        }
      };
      function Lc(a) {
        var b, c, d, e, g, f, h;
